...
groups = [Group("一", layout='monadtall'),
          ...
          Group("󰹛", matches=[Match(wm_class="orca-slicer")], layout="monadtall"),
          Group("", matches=[Match(wm_class="zoom")], layout="ratiotile")]
...
def init_widgets_list():
    widgets_list = [
              ...
              widget.Image(
                       ...
                       scale = "True",
                       background='#3C3836',
                       mouse_callbacks = {'Button1': lambda: qtile.spawn("sh /home/dave/.config/rofi/launchers/colorful/launcher.sh")},
                       ),
              widget.Image(
              ...
              widget.Clock(
                       ...
                       background = colors[0],
                       format = "%A, %B %d - %I:%M %p ",
                       mouse_callbacks = {'Button1': lambda: qtile.spawn(myTerm + ' -e calcurse')},
                       padding = 5,
                       ),
              widget.Spacer(
                      background = colors[0]
              ...
              widget.CPU(
                       mouse_callbacks = {'Button1': lambda: qtile.spawn(myTerm + ' -e missioncenter')},
                       background = "#3C3836",
                       foreground = colors[2],
                       samples = 60,
                       ),
...
def init_widgets_screen1():
    ...
    del widgets_screen1[23:32]               # Slicing removes unwanted widgets on Monitors 3
...
def init_widgets_screen3():
    ...
    del widgets_screen3[10:32]              # Slicing removes unwanted widgets (systray) on Monitors 2
